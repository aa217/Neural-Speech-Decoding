...
expName = 'DataCollectionExperiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Abdallah\\Desktop\\EEG DEVICE\\github_neuropawn\\Neural-Speech-Decoding\\DataCollectionExperiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        auditory_stimulus.setSound(audio, secs=0.5, hamming=True)
        auditory_stimulus.setVolume(1.0, log=False)
        ...
        while continueRoutine and routineTimer.getTime() < 6.0:
            ...
            if thisExp.status == PAUSED:
                pauseExperiment(
                    ...
                    win=win, 
                    timers=[routineTimer], 
                    playbackComponents=[auditory_stimulus]
                )
